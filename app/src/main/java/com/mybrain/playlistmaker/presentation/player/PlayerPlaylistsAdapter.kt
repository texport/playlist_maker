...
import com.mybrain.playlistmaker.databinding.ItemPlaylistBottomSheetBinding
...
) : ListAdapter<PlaylistUI, PlayerPlaylistsAdapter.PlaylistViewHolder>(DiffCallback()) {
